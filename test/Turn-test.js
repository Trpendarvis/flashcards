...
//   it.skip("should be a function and have two arg", function() {
//     const turn = new Turn()
//     expect(Turn).to.be.a('function')
//   }) 
  //this doesnt have logic / this does pass why?

  it.skip("should be a function and have two arguments", function() {
    const turn = new Turn("test1", {"correctAnswer": "test1"})
    expect(turn.userGuess).to.equal("test1")
  }) 

  it.skip("should have a card object for current card", function() {
  ...
  it.skip("should have a method that returns a boolean for correct guess or not", function(){
    const turn = new Turn("wrongGuess", {"id": 1, "correctAnswer": "correctGuess"})
    expect(turn.evaluateGuess()).to.equal(false)
    console.log("look here",turn)
  })

  it.skip("method that returns 'correct'/'incorrect' based on correctness of user guess", function(){
